...
def main():
	list = ["Americana","Botucatu","Cósmopolis","Descalvado","Embu das Artes","Franco da Rocha","Guarulhos","Hortolândia","Itupeva","Jundiai","Vargem Grande do Sul","Mauá"]
	results = osmr.getData(list)
	cities = []
	
	for r in results:
		cities.append(City(r['nam'],r['lat'],r['lon']))
